...
class SmsSpeedLimitTimeUnit(ModelSimple):
    """
    Attributes:
    ...
    def __init__(self, *args, **kwargs):
        """SmsSpeedLimitTimeUnit - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["MINUTE", "HOUR", "DAY", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["MINUTE", "HOUR", "DAY", ]  # noqa: E501
