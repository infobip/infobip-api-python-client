...
class CallsConferenceAndCall(BaseModel):
    """
    CallsConferenceAndCall
    """  # noqa: E501

    conference: Optional[CallsConference] = None
    call: Optional[Call] = None
    __properties: ClassVar[List[str]] = ["conference", "call"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsConferenceAndCall from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsConferenceAndCall from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "conference": CallsConference.from_dict(obj["conference"])
                if obj.get("conference") is not None
                else None,
                "call": Call.from_dict(obj["call"])
                if obj.get("call") is not None
                else None,
            }
        )
        return _obj
