...
class MessagesApiInboundTypingStartedEvent(MessagesApiInboundEvent):
    """
    MessagesApiInboundTypingStartedEvent
    """  # noqa: E501

    channel: MessagesApiInboundTypingIndicatorChannel
    ...
    event: MessagesApiInboundEventType = "TYPING_STARTED"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiInboundTypingStartedEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiInboundTypingStartedEvent from a dict"""
        if obj is None:
            return None
