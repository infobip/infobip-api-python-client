...
class CallsSendingSpeed(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["speed", "timeUnit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsSendingSpeed from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsSendingSpeed from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"speed": obj.get("speed"), "timeUnit": obj.get("timeUnit")}
        )
        return _obj
