...
class CallsConfigurationPage(BaseModel):
    """
    CallsConfigurationPage
    """  # noqa: E501

    results: Optional[List[CallsConfigurationResponse]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsConfigurationPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsConfigurationPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "results": [
                    CallsConfigurationResponse.from_dict(_item)
