...
class EmailMessageStatus(BaseModel):
    """
    ...
    group_name: Optional[EmailMessageGeneralStatus] = Field(
        default=None, alias="groupName"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailMessageStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailMessageStatus from a dict"""
        if obj is None:
            return None
