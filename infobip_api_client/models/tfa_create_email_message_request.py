...
class TfaCreateEmailMessageRequest(BaseModel):
    """
    TfaCreateEmailMessageRequest
    """  # noqa: E501

    email_template_id: StrictInt = Field(
    ...
    pin_length: Optional[StrictInt] = Field(
        default=4, description="PIN code length.", alias="pinLength"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TfaCreateEmailMessageRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TfaCreateEmailMessageRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "pinLength": (
                    obj.get("pinLength") if obj.get("pinLength") is not None else 4
                ),
