...
class CallEndpoint(BaseModel):
    ...
    type: Optional[CallEndpointType] = None
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[
        ...
        if object_type == "CallsPhoneEndpoint":
            return import_module(
                "infobip_api_client.models.calls_phone_endpoint"
            ).CallsPhoneEndpoint.from_dict(obj)
        if object_type == "CallsSipEndpoint":
            return import_module(
                "infobip_api_client.models.calls_sip_endpoint"
            ).CallsSipEndpoint.from_dict(obj)
        if object_type == "CallsViberEndpoint":
            return import_module(
                "infobip_api_client.models.calls_viber_endpoint"
            ).CallsViberEndpoint.from_dict(obj)
        if object_type == "CallsWebRtcEndpoint":
            return import_module(
        ...
        if object_type == "CallsWhatsAppEndpoint":
            return import_module(
                "infobip_api_client.models.calls_whats_app_endpoint"
            ).CallsWhatsAppEndpoint.from_dict(obj)
