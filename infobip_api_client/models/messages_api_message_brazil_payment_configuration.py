...
class MessagesApiMessageBrazilPaymentConfiguration(
    MessagesApiMessagePaymentConfiguration
):
    """
    ...
    type: MessagesApiMessagePaymentConfigurationType = "BRAZIL"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageBrazilPaymentConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageBrazilPaymentConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"type": obj.get("type"), "id": obj.get("id"), "name": obj.get("name")}
        )
        return _obj
