...
class MessagesApiIncomingMessageResponse(BaseModel):
    """
    MessagesApiIncomingMessageResponse
    """  # noqa: E501

    results: List[MessagesApiInboundEvent] = Field(description="Incoming messages")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiIncomingMessageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiIncomingMessageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "results": (
                    [
                        MessagesApiInboundEvent.from_dict(_item)
