...
class CallsPublicRegion(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "code", "countryCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsPublicRegion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsPublicRegion from a dict"""
        if obj is None:
            return None
