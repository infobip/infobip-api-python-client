...
class MessagesApiMessageLocationBody(MessagesApiMessageBody):
    """
    ...
    address: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=1000)]
    ] = Field(default=None, description="Location address.")
    type: MessagesApiMessageBodyType = "LOCATION"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageLocationBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageLocationBody from a dict"""
        if obj is None:
            return None
