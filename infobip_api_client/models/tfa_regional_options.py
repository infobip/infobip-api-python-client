...
class TfaRegionalOptions(BaseModel):
    """
    ...
    india_dlt: Optional[TfaIndiaDltOptions] = Field(default=None, alias="indiaDlt")
    __properties: ClassVar[List[str]] = ["indiaDlt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TfaRegionalOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TfaRegionalOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "indiaDlt": TfaIndiaDltOptions.from_dict(obj["indiaDlt"])
