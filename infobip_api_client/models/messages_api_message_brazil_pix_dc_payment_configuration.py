...
class MessagesApiMessageBrazilPixDcPaymentConfiguration(
    MessagesApiMessagePaymentConfiguration
):
    """
    ...
    code: Optional[StrictStr] = Field(
        default=None, description="Dynamic Pix code which will be copied by the buyer."
    )
    merchant_name: Optional[StrictStr] = Field(
        default=None, description="Pix account holder name.", alias="merchantName"
    )
    key_type: Optional[MessagesApiMessageBrazilPixDcPaymentContentKeyType] = Field(
        default=None, alias="keyType"
    )
    key: Optional[StrictStr] = Field(
        default=None, description="Key to identify the pix user’s account."
    )
    type: MessagesApiMessagePaymentConfigurationType = "BRAZIL_PIX_DC"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageBrazilPixDcPaymentConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageBrazilPixDcPaymentConfiguration from a dict"""
        if obj is None:
            return None
