...
class MessagesApiMessageRequestLocationButton(MessagesApiMessageButton):
    """
    MessagesApiMessageRequestLocationButton
    """  # noqa: E501

    text: Optional[StrictStr] = Field(
        default=None, description="Text to be displayed on the button."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageRequestLocationButton from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageRequestLocationButton from a dict"""
        if obj is None:
            return None
