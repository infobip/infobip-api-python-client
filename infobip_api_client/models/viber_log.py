...
class ViberLog(BaseModel):
    ...
    error: Optional[ViberMessageError] = None
    platform: Optional[Platform] = None
    content: Optional[ViberOutboundContent] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ViberLog from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ViberLog from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "error": (
                    ViberMessageError.from_dict(obj["error"])
                ...
                "content": (
                    ViberOutboundContent.from_dict(obj["content"])
