...
class CallRoutingCustomDataEntry(BaseModel):
    """
    WebRTC custom data. To meet the criteria, all of the provided custom data pairs must match.
    """  # noqa: E501

    key: StrictStr = Field(description="Custom data key. Example: `key1`.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallRoutingCustomDataEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallRoutingCustomDataEntry from a dict"""
        if obj is None:
            return None
