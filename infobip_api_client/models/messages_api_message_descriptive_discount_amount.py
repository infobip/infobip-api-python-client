...
class MessagesApiMessageDescriptiveDiscountAmount(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageDescriptiveDiscountAmount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageDescriptiveDiscountAmount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"value": obj.get("value"), "description": obj.get("description")}
        )
        return _obj
