...
class MessagesApiMessageBrazilLinkPaymentConfiguration(
    MessagesApiMessagePaymentConfiguration
):
    """
    ...
    type: MessagesApiMessagePaymentConfigurationType = "BRAZIL_LINK"
    __properties: ClassVar[List[str]] = ["type", "id", "paymentLink"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageBrazilLinkPaymentConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageBrazilLinkPaymentConfiguration from a dict"""
        if obj is None:
            return None
