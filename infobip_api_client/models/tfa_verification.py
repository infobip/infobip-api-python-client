...
class TfaVerification(BaseModel):
    """
    TfaVerification
    """  # noqa: E501
    ...
    verified_at: Optional[StrictInt] = Field(
        default=None,
        description="Verification UNIX timestamp (in millis), if the phone number (MSISDN) is verified.",
        alias="verifiedAt",
    )
    __properties: ClassVar[List[str]] = ["msisdn", "sentAt", "verified", "verifiedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TfaVerification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TfaVerification from a dict"""
        if obj is None:
            return None
