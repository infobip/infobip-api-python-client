...
class EmailBulkScheduleResponse(BaseModel):
    ...
    external_bulk_id: StrictStr = Field(
        description="The ID that uniquely identifies the sent bulk.",
        alias="externalBulkId",
    )
    bulks: List[EmailBulkInfo]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.bulks:
            for _item_bulks in self.bulks:
                if _item_bulks:
                    _items.append(_item_bulks.to_dict())
            _dict["bulks"] = _items
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "bulks": (
                    [EmailBulkInfo.from_dict(_item) for _item in obj["bulks"]]
