...
class MessagesApiWebhookEventTextContent(MessagesApiWebhookEventContent):
    """
    MessagesApiWebhookEventTextContent
    """  # noqa: E501

    text: StrictStr = Field(description="Text of the message.")
    ...
    type: MessagesApiWebhookEventContentType = "TEXT"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiWebhookEventTextContent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiWebhookEventTextContent from a dict"""
        if obj is None:
            return None
