...
class MessagesApiMessageStickerBody(MessagesApiMessageBody):
    """
    ...
    type: MessagesApiMessageBodyType = "STICKER"
    __properties: ClassVar[List[str]] = ["type", "reference"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageStickerBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageStickerBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"type": obj.get("type"), "reference": obj.get("reference")}
        )
        return _obj
