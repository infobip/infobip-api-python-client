...
class MessagesApiWebhookEventPaymentItem(BaseModel):
    """
    ...
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="(Apple specific) The monetary amount of the item."
    )
    ...
    __properties: ClassVar[List[str]] = ["name", "amount", "retailerId", "catalogId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiWebhookEventPaymentItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiWebhookEventPaymentItem from a dict"""
        if obj is None:
            return None
