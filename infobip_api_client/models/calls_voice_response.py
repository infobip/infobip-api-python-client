...
class CallsVoiceResponse(BaseModel):
    """
    CallsVoiceResponse
    """  # noqa: E501
    ...
    messages: Optional[List[CallsVoiceResponseDetails]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsVoiceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsVoiceResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "messages": [
                    CallsVoiceResponseDetails.from_dict(_item)
