...
class CallRoutingPhoneEndpoint(CallRoutingEndpoint):
    """
    ...
    ringback_generation: Optional[CallRoutingRingbackGeneration] = Field(
        default=None, alias="ringbackGeneration"
    )
    type: CallRoutingEndpointType = "PHONE"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallRoutingPhoneEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallRoutingPhoneEndpoint from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "ringbackGeneration": (
                    CallRoutingRingbackGeneration.from_dict(obj["ringbackGeneration"])
