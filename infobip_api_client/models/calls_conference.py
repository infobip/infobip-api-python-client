...
class CallsConference(BaseModel):
    """
    CallsConference
    """  # noqa: E501

    id: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(
        default=None, description="Unique conference ID."
    )
    name: Optional[StrictStr] = Field(
        default=None,
        description="Conference name, requested or autogenerated on creation.",
    )
    participants: Optional[List[CallsParticipant]] = Field(
        default=None, description="The list of conference participants."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsConference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsConference from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "participants": (
                    [CallsParticipant.from_dict(_item) for _item in obj["participants"]]
