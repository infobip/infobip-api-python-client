...
class CallsConnectRequest(BaseModel):
    """
    CallsConnectRequest
    """  # noqa: E501

    call_ids: List[StrictStr] = Field(
        description="IDs of the calls to connect.", alias="callIds"
    )
    conference_request: Optional[CallsActionConferenceRequest] = Field(
        default=None, alias="conferenceRequest"
    )
    __properties: ClassVar[List[str]] = ["callIds", "conferenceRequest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsConnectRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsConnectRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "callIds": obj.get("callIds"),
                "conferenceRequest": (
                    CallsActionConferenceRequest.from_dict(obj["conferenceRequest"])
