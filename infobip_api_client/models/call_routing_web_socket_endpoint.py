...
class CallRoutingWebSocketEndpoint(CallRoutingEndpoint):
    """
    CallRoutingWebSocketEndpoint
    """  # noqa: E501

    websocket_endpoint_config_id: StrictStr = Field(
        description="Websocket endpoint configuration ID.",
        alias="websocketEndpointConfigId",
    )
    identifier: Optional[StrictStr] = Field(
        default=None, description="Optional identifier for websocket calls."
    )
    ...
    type: CallRoutingEndpointType = "WEBSOCKET"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallRoutingWebSocketEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallRoutingWebSocketEndpoint from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "websocketEndpointConfigId": obj.get("websocketEndpointConfigId"),
