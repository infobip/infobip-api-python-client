...
class ViberRegionalOptions(BaseModel):
    """
    ...
    india_dlt: Optional[ViberIndiaDltOptions] = Field(default=None, alias="indiaDlt")
    turkey_iys: Optional[TurkeyIysOptions] = Field(default=None, alias="turkeyIys")
    south_korea: Optional[ViberSouthKoreaOptions] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ViberRegionalOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ViberRegionalOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "indiaDlt": (
                    ViberIndiaDltOptions.from_dict(obj["indiaDlt"])
                ...
                "southKorea": (
                    ViberSouthKoreaOptions.from_dict(obj["southKorea"])
