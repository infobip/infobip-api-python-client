...
class CallsGetVoicesResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsGetVoicesResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in voices (list)
        _items = []
        if self.voices:
            for _item_voices in self.voices:
                if _item_voices:
                    _items.append(_item_voices.to_dict())
            _dict["voices"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsGetVoicesResponse from a dict"""
        if obj is None:
            return None
