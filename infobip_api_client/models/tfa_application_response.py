...
class TfaApplicationResponse(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="2FA application name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TfaApplicationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TfaApplicationResponse from a dict"""
        if obj is None:
            return None
