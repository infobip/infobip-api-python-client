...
class ViberMessageDeliveryReporting(BaseModel):
    """
    ...
    receive_triggered_failover_reports: Optional[StrictBool] = Field(
        default=None,
        ...
        alias="receiveTriggeredFailoverReports",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ViberMessageDeliveryReporting from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ViberMessageDeliveryReporting from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "receiveTriggeredFailoverReports": obj.get(
                    "receiveTriggeredFailoverReports"
                ),
            }
        )
