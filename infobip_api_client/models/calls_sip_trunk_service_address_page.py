...
class CallsSipTrunkServiceAddressPage(BaseModel):
    """
    CallsSipTrunkServiceAddressPage
    """  # noqa: E501

    results: Optional[List[CallsPublicSipTrunkServiceAddress]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsSipTrunkServiceAddressPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsSipTrunkServiceAddressPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "results": [
                    CallsPublicSipTrunkServiceAddress.from_dict(_item)
