...
class MessagesApiChannelDestination(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["channel", "to", "messageId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiChannelDestination from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiChannelDestination from a dict"""
        if obj is None:
            return None
