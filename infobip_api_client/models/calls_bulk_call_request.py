...
class CallsBulkCallRequest(BaseModel):
    """
    Call request list.
    """  # noqa: E501
    ...
    endpoint: CallsBulkEndpoint
    __properties: ClassVar[List[str]] = ["externalId", "endpoint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsBulkCallRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsBulkCallRequest from a dict"""
        if obj is None:
            return None
