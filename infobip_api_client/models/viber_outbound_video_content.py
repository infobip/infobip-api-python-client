...
class ViberOutboundVideoContent(ViberOutboundContent):
    """
    ...
    ] = Field(default=None, description="Text to be displayed alongside the video.")
    ...
    ] = Field(default=None, description="Button title.", alias="buttonTitle")
    button: Optional[ViberButton] = None
    type: ViberOutboundContentType = "VIDEO"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ViberOutboundVideoContent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ViberOutboundVideoContent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "buttonTitle": obj.get("buttonTitle"),
                "button": (
