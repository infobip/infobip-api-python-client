...
class CallRoutingRouteResponsePage(BaseModel):
    """
    Routes response object.
    """  # noqa: E501

    results: Optional[List[CallRoutingRouteResponse]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallRoutingRouteResponsePage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallRoutingRouteResponsePage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "results": [
                    CallRoutingRouteResponse.from_dict(_item)
