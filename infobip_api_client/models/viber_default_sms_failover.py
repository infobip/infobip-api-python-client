...
class ViberDefaultSmsFailover(BaseModel):
    """
    ...
    regional: Optional[ViberRegionalOptions] = None
    __properties: ClassVar[List[str]] = ["sender", "text", "validityPeriod", "regional"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ViberDefaultSmsFailover from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ViberDefaultSmsFailover from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "regional": (
                    ViberRegionalOptions.from_dict(obj["regional"])
