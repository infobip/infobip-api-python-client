...
class MessagesApiEventRequest(BaseModel):
    """
    MessagesApiEventRequest
    """  # noqa: E501

    events: List[MessagesApiOutboundEvent] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiEventRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiEventRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "events": (
                    [
                        MessagesApiOutboundEvent.from_dict(_item)
