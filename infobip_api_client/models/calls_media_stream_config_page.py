...
class CallsMediaStreamConfigPage(BaseModel):
    """
    CallsMediaStreamConfigPage
    """  # noqa: E501

    results: Optional[List[CallsMediaStreamConfigResponse]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsMediaStreamConfigPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsMediaStreamConfigPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "results": [
                    CallsMediaStreamConfigResponse.from_dict(_item)
