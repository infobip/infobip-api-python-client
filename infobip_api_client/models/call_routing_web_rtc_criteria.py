...
class CallRoutingWebRTCCriteria(CallRoutingCriteria):
    """
    ...
    custom_data: Optional[List[CallRoutingCustomDataEntry]] = Field(
        default=None,
        description="WebRTC custom data. To meet the criteria, all of the provided custom data pairs must match.",
        alias="customData",
    )
    type: CallRoutingCriteriaType = "WEBRTC"
    __properties: ClassVar[List[str]] = ["type", "identity", "customData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallRoutingWebRTCCriteria from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallRoutingWebRTCCriteria from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "customData": (
                    [
                        CallRoutingCustomDataEntry.from_dict(_item)
                        for _item in obj["customData"]
                    ]
