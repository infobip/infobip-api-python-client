...
class CallsSipTrunkPage(BaseModel):
    """
    CallsSipTrunkPage
    """  # noqa: E501

    results: Optional[List[CallsSipTrunkResponse]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsSipTrunkPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsSipTrunkPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "results": [
                    CallsSipTrunkResponse.from_dict(_item) for _item in obj["results"]
                ]
