...
class CallsConferenceRecordingRequest(BaseModel):
    """
    CallsConferenceRecordingRequest
    """  # noqa: E501

    recording_type: CallsRecordingType = Field(alias="recordingType")
    conference_composition: Optional[CallsConferenceComposition] = Field(
        default=None, alias="conferenceComposition"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsConferenceRecordingRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of conference_composition
        if self.conference_composition:
            _dict["conferenceComposition"] = self.conference_composition.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsConferenceRecordingRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "conferenceComposition": CallsConferenceComposition.from_dict(
                    obj["conferenceComposition"]
                )
                if obj.get("conferenceComposition") is not None
                else None,
