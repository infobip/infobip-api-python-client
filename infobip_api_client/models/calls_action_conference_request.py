...
class CallsActionConferenceRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "recording", "maxDuration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsActionConferenceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsActionConferenceRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "recording": (
                    CallsConferenceRecordingRequest.from_dict(obj["recording"])
