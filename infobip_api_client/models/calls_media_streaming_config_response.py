...
class CallsMediaStreamingConfigResponse(CallsMediaStreamConfigResponse):
    """
    CallsMediaStreamingConfigResponse
    """  # noqa: E501

    type: CallsResponseMediaStreamConfigType = "MEDIA_STREAMING"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsMediaStreamingConfigResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsMediaStreamingConfigResponse from a dict"""
        if obj is None:
            return None
