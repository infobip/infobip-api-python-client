...
class CallsMediaProperties(BaseModel):
    """
    CallsMediaProperties
    """  # noqa: E501

    audio: Optional[CallsAudioMediaProperties] = None
    video: Optional[CallsVideoMediaProperties] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsMediaProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsMediaProperties from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "audio": CallsAudioMediaProperties.from_dict(obj["audio"])
                if obj.get("audio") is not None
                else None,
                "video": CallsVideoMediaProperties.from_dict(obj["video"])
