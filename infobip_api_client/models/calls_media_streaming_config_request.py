...
class CallsMediaStreamingConfigRequest(CallsMediaStreamConfigRequest):
    """
    ...
    type: CallsRequestMediaStreamConfigType = "MEDIA_STREAMING"
    __properties: ClassVar[List[str]] = ["type", "name", "url", "securityConfig"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsMediaStreamingConfigRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsMediaStreamingConfigRequest from a dict"""
        if obj is None:
            return None
