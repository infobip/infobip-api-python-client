...
class CallsConferenceRecording(BaseModel):
    ...
    conference_id: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(
        default=None, description="Conference ID.", alias="conferenceId"
    )
    conference_name: Optional[StrictStr] = Field(
        default=None, description="Conference name.", alias="conferenceName"
    )
