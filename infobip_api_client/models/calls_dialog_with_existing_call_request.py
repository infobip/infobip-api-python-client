...
class CallsDialogWithExistingCallRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsDialogWithExistingCallRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsDialogWithExistingCallRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "recording": CallsDialogRecordingRequest.from_dict(obj["recording"])
                if obj.get("recording") is not None
                else None,
                "maxDuration": obj.get("maxDuration")
                if obj.get("maxDuration") is not None
                else 28800,
                "propagationOptions": CallsDialogPropagationOptions.from_dict(
                    obj["propagationOptions"]
                )
