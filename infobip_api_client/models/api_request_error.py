...
class ApiRequestError(BaseModel):
    """
    ApiRequestError
    """  # noqa: E501

    service_exception: Optional[ApiRequestErrorDetails] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiRequestError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiRequestError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "serviceException": (
                    ApiRequestErrorDetails.from_dict(obj["serviceException"])
