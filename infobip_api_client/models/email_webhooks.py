...
class EmailWebhooks(BaseModel):
    """
    Provides options for configuring message webhooks.
    """  # noqa: E501

    delivery: Optional[EmailMessageDeliveryReporting] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailWebhooks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailWebhooks from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "delivery": (
                    EmailMessageDeliveryReporting.from_dict(obj["delivery"])
