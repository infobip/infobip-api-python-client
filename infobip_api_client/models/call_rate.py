...
class CallRate(BaseModel):
    ...
    max_calls: Optional[StrictInt] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallRate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallRate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"maxCalls": obj.get("maxCalls"), "timeUnit": obj.get("timeUnit")}
        )
        return _obj
