...
class MessagesApiMessageCarouselCard(BaseModel):
    """
    Carousel cards.
    """  # noqa: E501

    body: MessagesApiMessageCarouselCardBody
    buttons: Optional[List[MessagesApiMessageButton]] = Field(
        default=None, description="List of buttons of a card."
    )
    __properties: ClassVar[List[str]] = ["body", "buttons"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageCarouselCard from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageCarouselCard from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "body": (
                    MessagesApiMessageCarouselCardBody.from_dict(obj["body"])
