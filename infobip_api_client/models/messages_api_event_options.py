...
class MessagesApiEventOptions(BaseModel):
    """
    Event options.
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["platform", "validityPeriod"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiEventOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiEventOptions from a dict"""
        if obj is None:
            return None
