...
class CallsOnDemandComposition(BaseModel):
    """
    Composition request.
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsOnDemandComposition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsOnDemandComposition from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "deleteCallRecordings": (
                    obj.get("deleteCallRecordings")
                    if obj.get("deleteCallRecordings") is not None
                    else True
                ),
                "multiChannel": (
                    CallsMultiChannel.from_dict(obj["multiChannel"])
