...
class CallsClickToCallMessageBody(BaseModel):
    """
    ...
    messages: List[CallsClickToCallMessage] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsClickToCallMessageBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsClickToCallMessageBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "messages": (
                    [
                        CallsClickToCallMessage.from_dict(_item)
