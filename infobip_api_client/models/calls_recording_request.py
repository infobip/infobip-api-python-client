...
class CallsRecordingRequest(BaseModel):
    """
    ...
    file_prefix: Optional[StrictStr] = Field(
        default=None,
        description="Custom name for the recording's zip file. Applicable only when SFTP server is enabled on [Voice settings page](https://portal.infobip.com/apps/voice/recording/settings). Using the same `filePrefix` will override the files on the SFTP server.",
        alias="filePrefix",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsRecordingRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsRecordingRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "beep": obj.get("beep") if obj.get("beep") is not None else False,
