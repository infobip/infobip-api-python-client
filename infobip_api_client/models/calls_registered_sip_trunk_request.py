...
class CallsRegisteredSipTrunkRequest(CallsSipTrunkRequest):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsRegisteredSipTrunkRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsRegisteredSipTrunkRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "inviteAuthentication": (
                    obj.get("inviteAuthentication")
                    if obj.get("inviteAuthentication") is not None
                    else False
                ),
            }
        )
