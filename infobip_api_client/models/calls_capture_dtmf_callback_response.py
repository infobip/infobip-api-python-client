        ...
        _obj = cls.model_validate(
            {
                ...
                "maxLength": (
                    obj.get("maxLength") if obj.get("maxLength") is not None else 15
                ),
                "timeout": obj.get("timeout"),
                "digitTimeout": obj.get("digitTimeout"),
                "terminator": (
                    obj.get("terminator") if obj.get("terminator") is not None else "#"
                ),
                "addCountryCode": (
                    obj.get("addCountryCode")
