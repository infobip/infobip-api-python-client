...
class CallsWebsocketEndpointConfigResponse(CallsMediaStreamConfigResponse):
    """
    ...
    type: CallsResponseMediaStreamConfigType = "WEBSOCKET_ENDPOINT"
    __properties: ClassVar[List[str]] = ["id", "type", "name", "url", "sampleRate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsWebsocketEndpointConfigResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsWebsocketEndpointConfigResponse from a dict"""
        if obj is None:
            return None
