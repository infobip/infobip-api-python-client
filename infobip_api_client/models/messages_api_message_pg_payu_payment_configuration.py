...
class MessagesApiMessagePgPayuPaymentConfiguration(
    MessagesApiMessagePaymentConfiguration
):
    """
    ...
    callback_data: Optional[
        Annotated[
            List[Annotated[str, Field(min_length=1, strict=True, max_length=255)]],
    ...
    type: MessagesApiMessagePaymentConfigurationType = "PG_PAYU"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessagePgPayuPaymentConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessagePgPayuPaymentConfiguration from a dict"""
        if obj is None:
            return None
