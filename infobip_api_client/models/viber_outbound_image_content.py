...
class ViberOutboundImageContent(ViberOutboundContent):
    """
    ...
    show_image_in_full_screen: Optional[StrictBool] = Field(
        default=False,
        ...
        alias="showImageInFullScreen",
    )
    button: Optional[ViberButton] = None
    type: ViberOutboundContentType = "IMAGE"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ViberOutboundImageContent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ViberOutboundImageContent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "showImageInFullScreen": (
                    obj.get("showImageInFullScreen")
                    if obj.get("showImageInFullScreen") is not None
                    else False
                ),
                "button": (
