...
class CallsAdvancedBody(BaseModel):
    """
    CallsAdvancedBody
    """  # noqa: E501
    ...
    messages: List[CallsAdvancedMessage] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsAdvancedBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsAdvancedBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "messages": (
                    [CallsAdvancedMessage.from_dict(_item) for _item in obj["messages"]]
