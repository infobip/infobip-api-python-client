...
class CallRoutingWebRtcEndpoint(CallRoutingEndpoint):
    """
    ...
    type: CallRoutingEndpointType = "WEBRTC"
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallRoutingWebRtcEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallRoutingWebRtcEndpoint from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"type": obj.get("type"), "identity": obj.get("identity")}
        )
        return _obj
