...
class TfaStartAuthenticationRequest(BaseModel):
    """
    ...
    track_delivery: Optional[StrictBool] = Field(
        default=False,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TfaStartAuthenticationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TfaStartAuthenticationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "to": obj.get("to"),
                "trackDelivery": (
                    obj.get("trackDelivery")
                    if obj.get("trackDelivery") is not None
                    else False
                ),
            }
        )
