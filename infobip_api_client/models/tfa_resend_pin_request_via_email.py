...
class TfaResendPinRequestViaEmail(BaseModel):
    """
    TfaResendPinRequestViaEmail
    """  # noqa: E501

    landing_page_placeholders: Optional[Dict[str, StrictStr]] = Field(
        default=None,
    ...
    placeholders: Optional[Dict[str, StrictStr]] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["landingPagePlaceholders", "placeholders"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TfaResendPinRequestViaEmail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TfaResendPinRequestViaEmail from a dict"""
        if obj is None:
            return None
