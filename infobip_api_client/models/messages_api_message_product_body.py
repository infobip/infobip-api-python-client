...
class MessagesApiMessageProductBody(MessagesApiMessageBody):
    """
    ...
    catalog_id: StrictStr = Field(
        description="The ID that uniquely identifies the catalog", alias="catalogId"
    )
    sections: List[MessagesApiMessageProductSection] = Field(
        description="An array of product sections. Header and title fields are required in case of multiple products."
    )
    type: MessagesApiMessageBodyType = "PRODUCT"
    __properties: ClassVar[List[str]] = ["type", "text", "catalogId", "sections"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesApiMessageProductBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesApiMessageProductBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "sections": (
                    [
                        MessagesApiMessageProductSection.from_dict(_item)
