...
class CallRoutingCallRoutingRecordingPage(BaseModel):
    """
    CallRoutingCallRoutingRecordingPage
    """  # noqa: E501

    results: Optional[List[CallRoutingRecordingApiResponse]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallRoutingCallRoutingRecordingPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallRoutingCallRoutingRecordingPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "results": (
                    [
                        CallRoutingRecordingApiResponse.from_dict(_item)
