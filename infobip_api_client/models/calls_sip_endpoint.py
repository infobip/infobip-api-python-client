...
class CallsSipEndpoint(CallEndpoint):
    """
    CallsSipEndpoint
    """  # noqa: E501

    username: StrictStr = Field(description="SIP endpoint username.")
    sip_trunk_id: StrictStr = Field(description="SIP trunk ID.", alias="sipTrunkId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsSipEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsSipEndpoint from a dict"""
        if obj is None:
            return None
