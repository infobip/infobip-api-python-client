...
class CallsWebRtcEndpoint(CallEndpoint):
    """
    CallsWebRtcEndpoint
    """  # noqa: E501
    ...
    type: CallEndpointType = "WEBRTC"
    __properties: ClassVar[List[str]] = ["type", "identity", "displayName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallsWebRtcEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallsWebRtcEndpoint from a dict"""
        if obj is None:
            return None
