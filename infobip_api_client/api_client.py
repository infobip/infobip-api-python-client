...
from infobip_api_client import rest
from infobip_api_client.configuration import Configuration
from infobip_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.user_agent = "infobip-api-client-python/3.0.0"
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ReceiveSmsApi()
        api_instance.get_inbound_sms_messages  # this is an instance of the class Endpoint
        api_instance.get_inbound_sms_messages()  # this invokes api_instance.get_inbound_sms_messages.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_inbound_sms_messages.callable or self.callable in this class
