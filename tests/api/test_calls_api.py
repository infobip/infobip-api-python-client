...
def test_should_capture_speech(httpserver: HTTPServer, get_api_client):
    ...
    given_terminate_on_key_phrase = True
    given_advanced_formatting = False
    ...
    given_request = {
        ...
        "terminateOnKeyPhrase": given_terminate_on_key_phrase,
        "advancedFormatting": given_advanced_formatting,
    }
...
def test_should_conference_update_call(httpserver: HTTPServer, get_api_client):
    ...
    request: CallsUpdateCallRequest = CallsUpdateCallRequest(muted=given_muted)

    api_response = api_instance.update_conference_call(
        conference_id=given_conference_id,
        call_id=given_call_id,
        calls_update_call_request=request,
    )
...
def test_should_conference_say_text(httpserver: HTTPServer, get_api_client):
    ...
    request: CallsConferenceSayRequest = CallsConferenceSayRequest(
        text=given_text,
        language=given_language,
    ...
    api_response = api_instance.conference_say_text(
        calls_conference_say_request=request, conference_id=given_conference_id
    )
