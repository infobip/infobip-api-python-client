...
from infobip_api_python_client.infobip_api.models.nc.lookup.sync.NCResponseDetails import NCResponseDetails

class NCResponse(DefaultObject):
    @property
    ...
    @property
    @serializable(name="results", type=NCResponseDetails, list=True)
    def results(self):
